...
try:
    ...
    from ansible_collections.f5.network.plugins.module_utils.compat.ipaddress import ip_network
    from ansible_collections.f5.network.plugins.module_utils.compat.ipaddress import ip_interface
