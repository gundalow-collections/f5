...
from ansible_collections.f5.network.plugins.module_utils.network.common.utils import to_netmask
...
try:
    ...
    from ansible_collections.f5.common.plugins.module_utils.network.f5.icontrol import tmos_version
    from ansible_collections.f5.common.plugins.module_utils.network.f5.urls import parseStats
