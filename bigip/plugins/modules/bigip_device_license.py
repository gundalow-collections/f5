...
options:
  ...
  license_server:
    description:
      ...
      - This parameter is not required when C(state) is C(absent) and will be
        ignored if it is provided.
    type: str
    default: activate.f5.common.f5.com
  state:
    description:
  ...
  accept_eula:
    description:
      ...
      - The EULA can be found here; https://support.f5.common.f5.com/csp/article/K12902.
      - This parameter is not required when C(state) is C(absent) and will be
        ignored if it is provided.
    type: bool
    default: no
...
try:
    ...
    from ansible_collections.f5.common.plugins.module_utils.network.f5.icontrol import iControlRestSession
