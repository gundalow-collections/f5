...
notes:
  ...
  - If you are using this module with either Ansible Tower or Ansible AWX, you
    ...
    https://clouddocs.f5.common.f5.com/products/orchestration/ansible/devel/usage/module-usage-with-tower.html
...
try:
    ...
    from ansible_collections.f5.common.plugins.module_utils.network.f5.icontrol import download_file
