...
from ansible_collections.f5.network.plugins.module_utils.network.common.utils import load_provider
...
try:
    ...
    from ansible_collections.f5.common.plugins.module_utils.network.f5.common import f5_provider_spec
