...
try:
    ...
    from ansible_collections.f5.common.plugins.module_utils.network.f5.common import F5BaseClient
    from ansible_collections.f5.common.plugins.module_utils.network.f5.common import F5ModuleError
    from ansible_collections.f5.common.plugins.module_utils.network.f5.common import is_ansible_debug
